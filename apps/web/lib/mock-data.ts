...
import { buildPropertyImages } from "@/lib/listings";
...
export const properties: PropertyDetail[] = [
  {
    ...
    bathrooms: 3,
    sizeSqm: 210,
    images: buildPropertyImages("apartment", 0, 6),
    verificationState: "verified",
  ...
  },
  {
    ...
    bathrooms: 2,
    sizeSqm: 140,
    images: buildPropertyImages("office", 1, 4),
    verificationState: "pending",
  ...
  },
  {
    ...
    bathrooms: 5,
    sizeSqm: 380,
    images: buildPropertyImages("duplex", 2, 8),
  ...
  },
  {
    ...
    bathrooms: 0,
    sizeSqm: 1000,
    images: buildPropertyImages("land", 3, 3),
    verificationState: "verified",
  ...
  },
  {
    ...
    bathrooms: 2,
    sizeSqm: 95,
    images: buildPropertyImages("apartment", 0, 5),
    verificationState: "verified",
    listedBy: { slug: "ngozi-adeyemi", name: "Ngozi Adeyemi", role: "agent" },
    isFavorited: false,
    description:
  ...
  },
  {
    ...
    bathrooms: 1,
    sizeSqm: 32,
    images: buildPropertyImages("shop", 2, 2),
  ...
  },
  {
    ...
    bathrooms: 4,
    sizeSqm: 350,
    images: buildPropertyImages("duplex", 1, 5),
    verificationState: "verified",
  ...
  },
  {
    ...
    bathrooms: 2,
    sizeSqm: 160,
    images: buildPropertyImages("bungalow", 3, 4),
    verificationState: "pending",
    listedBy: { slug: "bisi-adewale", name: "Bisi Adewale", role: "agent" },
    isFavorited: false,
    description:
  ...
  },
  {
    ...
    bathrooms: 2,
    sizeSqm: 85,
    images: buildPropertyImages("apartment", 2, 4),
    verificationState: "verified",
    listedBy: { slug: "bisi-adewale", name: "Bisi Adewale", role: "agent" },
    isFavorited: false,
    description:
  ...
  },
  {
    ...
    bathrooms: 1,
    sizeSqm: 28,
    images: buildPropertyImages("studio", 0, 3),
    verificationState: "pending",
    listedBy: { slug: "bisi-adewale", name: "Bisi Adewale", role: "agent" },
    isFavorited: false,
    description:
  ...
  },
  {
    ...
    bathrooms: 2,
    sizeSqm: 120,
    images: buildPropertyImages("apartment", 3, 5),
    verificationState: "verified",
    listedBy: { slug: "adaeze-okafor", name: "Adaeze Okafor", role: "agent" },
    isFavorited: false,
    description:
